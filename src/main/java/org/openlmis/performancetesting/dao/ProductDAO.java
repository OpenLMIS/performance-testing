...
public class ProductDAO {
  ...
  public Product getProduct(int offset) {
    String sql = "SELECT id, code, fullSupply FROM products LIMIT 1 OFFSET :offset";
    ...
    Boolean fullSupply = (Boolean) values.get(0).get("fullSupply");

    Product product = new Product();
    product.setId(productId);
    product.setCode(productCode);
    product.setFullSupply(fullSupply);
